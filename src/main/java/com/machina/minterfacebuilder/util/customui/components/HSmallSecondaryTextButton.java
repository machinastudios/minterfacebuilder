 ...
 */
public class HSmallSecondaryTextButton extends HytaleCustomUIComponent {
    ...
    public HSmallSecondaryTextButton(Map<String, String> attributes) {
        ...
        defaultState.put("Background", LiteralValue.of("PatchStyle(TexturePath: \"Common/Buttons/Secondary.png\", Border: 12)"));
        ...
        hoveredState.put("Background", LiteralValue.of("PatchStyle(TexturePath: \"Common/Buttons/Secondary_Hovered.png\", Border: 12)"));
        ...
        pressedState.put("Background", LiteralValue.of("PatchStyle(TexturePath: \"Common/Buttons/Secondary_Pressed.png\", Border: 12)"));
