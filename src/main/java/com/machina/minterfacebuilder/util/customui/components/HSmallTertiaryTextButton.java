...
/**
 * H Small Tertiary TextButton component with inline expanded styles.
 * Based on @SmallTertiaryTextButton from Common.ui (line 240-253).
 */
public class HSmallTertiaryTextButton extends HytaleCustomUIComponent {
    public static final String TAG_NAME = "HSmallTertiaryTextButton";

    public HSmallTertiaryTextButton(Map<String, String> attributes) {
        super("TextButton");
        
        // Configure Anchor
        Map<String, Object> anchor = new HashMap<>();
        anchor.put("Height", 32); // @SmallButtonHeight expanded
        ...
        defaultState.put("Background", LiteralValue.of("PatchStyle(TexturePath: \"Common/Buttons/Tertiary.png\", Border: 12)"));
        ...
        hoveredState.put("Background", LiteralValue.of("PatchStyle(TexturePath: \"Common/Buttons/Tertiary_Hovered.png\", Border: 12)"));
        ...
        pressedState.put("Background", LiteralValue.of("PatchStyle(TexturePath: \"Common/Buttons/Tertiary_Pressed.png\", Border: 12)"));
        ...
        disabledLabelStyle.put("FontSize", 14);
